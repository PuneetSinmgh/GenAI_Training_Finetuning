...
# installed.
TK_PREFIX='/Users/puneetsingh/AI Projects/GenAI_&_LLMs_certification/RAG_Huggingface/envs'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/puneetsingh/AI Projects/GenAI_&_LLMs_certification/RAG_Huggingface/envs'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/puneetsingh/AI Projects/GenAI_&_LLMs_certification/RAG_Huggingface/envs/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/puneetsingh/AI Projects/GenAI_&_LLMs_certification/RAG_Huggingface/envs/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/puneetsingh/AI Projects/GenAI_&_LLMs_certification/RAG_Huggingface/envs/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/puneetsingh/AI Projects/GenAI_&_LLMs_certification/RAG_Huggingface/envs/lib/libtkstub8.6.a'
